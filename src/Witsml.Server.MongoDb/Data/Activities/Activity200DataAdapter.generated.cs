...
namespace PDS.Witsml.Server.Data.Activities
{
    ...
    /// </summary>
    /// <seealso cref="PDS.Witsml.Server.Data.MongoDbDataAdapter{Activity}" />
    ...
    public partial class Activity200DataAdapter : MongoDbDataAdapter<Activity>
    {
        ...
        public override List<Activity> GetAll(EtpUri? parentUri)
        {
            Logger.DebugFormat("Fetching all Activities; Parent URI: {0}", parentUri);
