...
namespace PDS.Witsml.Server.Data.RigUtilizations
{
    ...
    /// </summary>
    /// <seealso cref="PDS.Witsml.Server.Data.EtpDataProvider{RigUtilization}" />
    ...
    public partial class RigUtilization200DataProvider : EtpDataProvider<RigUtilization>
    {
        ...
        public RigUtilization200DataProvider(IContainer container, IWitsmlDataAdapter<RigUtilization> dataAdapter) : base(container, dataAdapter)
        {
        }
        ...
        protected override void SetDefaultValues(RigUtilization dataObject)
        {
        ...
        protected override void SetDefaultValues(RigUtilization dataObject, EtpUri uri)
        {
        ...
        /// </summary>
        /// <param name="dataObject">The data object.</param>
        partial void SetAdditionalDefaultValues(RigUtilization dataObject);
