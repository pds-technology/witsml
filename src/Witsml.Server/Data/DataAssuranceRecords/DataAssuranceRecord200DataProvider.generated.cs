...
namespace PDS.Witsml.Server.Data.DataAssuranceRecords
{
    ...
    /// </summary>
    /// <seealso cref="PDS.Witsml.Server.Data.EtpDataProvider{DataAssuranceRecord}" />
    ...
    public partial class DataAssuranceRecord200DataProvider : EtpDataProvider<DataAssuranceRecord>
    {
        ...
        public DataAssuranceRecord200DataProvider(IContainer container, IWitsmlDataAdapter<DataAssuranceRecord> dataAdapter) : base(container, dataAdapter)
        {
        }
        ...
        protected override void SetDefaultValues(DataAssuranceRecord dataObject)
        {
        ...
        protected override void SetDefaultValues(DataAssuranceRecord dataObject, EtpUri uri)
        {
        ...
        protected override void UpdateDefaultValues(DataAssuranceRecord dataObject, WitsmlQueryParser parser)
        {
        ...
        /// </summary>
        /// <param name="dataObject">The data object.</param>
        partial void SetAdditionalDefaultValues(DataAssuranceRecord dataObject);
        ...
        /// <param name="dataObject">The data object.</param>
        /// <param name="parser">The input template.</param>
        partial void UpdateAdditionalDefaultValues(DataAssuranceRecord dataObject, WitsmlQueryParser parser);
    }
}