...
namespace PDS.Witsml.Server.Data.Trajectories
{
    ...
    public class Trajectory131DataProvider : WitsmlDataProvider<TrajectoryList, Trajectory>
    {
        /// <summary>
        ...
        public Trajectory131DataProvider(IContainer container, IWitsmlDataAdapter<Trajectory> dataAdapter) : base(container, dataAdapter)
        {
        }
