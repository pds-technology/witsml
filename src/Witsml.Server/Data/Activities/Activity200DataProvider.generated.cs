...
namespace PDS.Witsml.Server.Data.Activities
{
    ...
    /// </summary>
    /// <seealso cref="PDS.Witsml.Server.Data.EtpDataProvider{Activity}" />
    ...
    public partial class Activity200DataProvider : EtpDataProvider<Activity>
    {
        ...
        public Activity200DataProvider(IContainer container, IWitsmlDataAdapter<Activity> dataAdapter) : base(container, dataAdapter)
        {
        }
        ...
        protected override void SetDefaultValues(Activity dataObject)
        {
        ...
        protected override void UpdateDefaultValues(Activity dataObject, WitsmlQueryParser parser)
        {
        ...
        /// </summary>
        /// <param name="dataObject">The data object.</param>
        partial void SetAdditionalDefaultValues(Activity dataObject);
        ...
        /// <param name="dataObject">The data object.</param>
        /// <param name="parser">The input template.</param>
        partial void UpdateAdditionalDefaultValues(Activity dataObject, WitsmlQueryParser parser);
    }
}