...
namespace PDS.Witsml.Server.Configuration
{
    ...
    public class CapServer141Provider : CapServerProvider<Witsml141.CapServers>
    {
        ...
        public override void ValidateRequest(RequestContext context, XDocument document)
        {
            ...
            {
                ValidateKeywords(optionsIn, OptionsIn.ReturnElements.Keyword, OptionsIn.RequestObjectSelectionCapability.Keyword, OptionsIn.RequestPrivateGroupOnly.Keyword, OptionsIn.CompressionMethod.Keyword, OptionsIn.RequestLatestValues.Keyword);  
