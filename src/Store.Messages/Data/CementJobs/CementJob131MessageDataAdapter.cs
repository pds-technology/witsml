...
namespace PDS.WITSMLstudio.Store.Data.CementJobs
{
    ...
    public class CementJob131MessageDataAdapter : MessageDataAdapter<CementJob>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CementJob131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public CementJob131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.CementJob131)
        {
