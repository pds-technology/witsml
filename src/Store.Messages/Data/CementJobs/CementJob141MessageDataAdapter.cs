...
namespace PDS.WITSMLstudio.Store.Data.CementJobs
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MessageDataAdapter{CementJob}" />
    ...
    [Export141(ObjectTypes.CementJob, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class CementJob141MessageDataAdapter : MessageDataAdapter<CementJob>, IWitsml141Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CementJob141MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public CementJob141MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.CementJob141)
        {
