...
namespace PDS.WITSMLstudio.Store.Data.WbGeometries
{
    ...
    public class WbGeometry131MessageDataAdapter : MessageDataAdapter<WbGeometry>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WbGeometry131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public WbGeometry131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.WbGeometry131)
        {
