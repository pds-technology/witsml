...
namespace PDS.WITSMLstudio.Store.Data.WbGeometries
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MessageDataAdapter{WbGeometry}" />
    ...
    public class WbGeometry141MessageDataAdapter : MessageDataAdapter<WbGeometry>, IWitsml141Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WbGeometry141MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public WbGeometry141MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.WbGeometry141)
        {
