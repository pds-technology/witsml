...
namespace PDS.WITSMLstudio.Store.Data.Attachments
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MessageDataAdapter{Attachment}" />
    ...
    public class Attachment141MessageDataAdapter : MessageDataAdapter<Attachment>, IWitsml141Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Attachment141MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Attachment141MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Attachment141)
        {
