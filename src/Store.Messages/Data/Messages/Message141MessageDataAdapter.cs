...
namespace PDS.WITSMLstudio.Store.Data.Messages
{
    ...
    public class Message141MessageDataAdapter : MessageDataAdapter<Message>, IWitsml141Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Message141MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Message141MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Message141)
        {
