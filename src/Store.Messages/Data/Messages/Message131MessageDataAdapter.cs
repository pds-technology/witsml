...
namespace PDS.WITSMLstudio.Store.Data.Messages
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MessageDataAdapter{Message}" />
    ...
    [Export131(ObjectTypes.Message, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class Message131MessageDataAdapter : MessageDataAdapter<Message>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Message131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Message131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Message131)
        {
