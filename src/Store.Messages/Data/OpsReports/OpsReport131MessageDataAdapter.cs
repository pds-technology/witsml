...
namespace PDS.WITSMLstudio.Store.Data.OpsReports
{
    ...
    public class OpsReport131MessageDataAdapter : MessageDataAdapter<OpsReport>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpsReport131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public OpsReport131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.OpsReport131)
        {
