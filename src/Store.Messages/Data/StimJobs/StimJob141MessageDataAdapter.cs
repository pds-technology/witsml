...
namespace PDS.WITSMLstudio.Store.Data.StimJobs
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MessageDataAdapter{StimJob}" />
    /// <seealso cref="PDS.WITSMLstudio.Store.Configuration.IWitsml141Configuration" />
    [Export(typeof(IWitsml141Configuration))]
    [Export(typeof(IWitsmlDataAdapter<StimJob>))]
    [Export141(ObjectTypes.StimJob, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class StimJob141MessageDataAdapter : MessageDataAdapter<StimJob>, IWitsml141Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StimJob141MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public StimJob141MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.StimJob141)
        {
