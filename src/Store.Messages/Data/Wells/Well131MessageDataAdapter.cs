...
namespace PDS.WITSMLstudio.Store.Data.Wells
{
    ...
    public class Well131MessageDataAdapter : MessageDataAdapter<Well>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Well131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Well131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Well131)
        {
