...
namespace PDS.WITSMLstudio.Store.Data.Channels
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MessageDataAdapter{Channel}" />
    [Export(typeof(IWitsmlDataAdapter<Channel>))]
    [Export200(ObjectTypes.Channel, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class Channel200MessageDataAdapter : MessageDataAdapter<Channel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Channel200MessageDataAdapter"/> class.
        /// </summary>
