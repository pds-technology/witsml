...
namespace PDS.WITSMLstudio.Store.Data.Wellbores
{
    ...
    public class Wellbore131MessageDataAdapter : MessageDataAdapter<Wellbore>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Wellbore131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Wellbore131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Wellbore131)
        {
