...
namespace PDS.WITSMLstudio.Store.Data.Tubulars
{
    ...
    [Export141(ObjectTypes.Tubular, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class Tubular141MessageDataAdapter : MessageDataAdapter<Tubular>, IWitsml141Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Tubular141MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Tubular141MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Tubular141)
        {
