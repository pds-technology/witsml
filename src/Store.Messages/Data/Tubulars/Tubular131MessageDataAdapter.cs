...
namespace PDS.WITSMLstudio.Store.Data.Tubulars
{
    ...
    public class Tubular131MessageDataAdapter : MessageDataAdapter<Tubular>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Tubular131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Tubular131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Tubular131)
        {
