...
namespace PDS.WITSMLstudio.Store.Data.Rigs
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MessageDataAdapter{Rig}" />
    ...
    public class Rig141MessageDataAdapter : MessageDataAdapter<Rig>, IWitsml141Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rig141MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Rig141MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Rig141)
        {
