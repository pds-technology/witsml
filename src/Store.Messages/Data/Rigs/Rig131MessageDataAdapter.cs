...
namespace PDS.WITSMLstudio.Store.Data.Rigs
{
    ...
    public class Rig131MessageDataAdapter : MessageDataAdapter<Rig>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rig131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Rig131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Rig131)
        {
