...
namespace PDS.WITSMLstudio.Store.Data.Logs
{
    ...
    public class Log200MessageDataAdapter : MessageDataAdapter<Log>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Log200MessageDataAdapter"/> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Log200MessageDataAdapter(IContainer container) : base(container, ObjectNames.Log200)
        {
