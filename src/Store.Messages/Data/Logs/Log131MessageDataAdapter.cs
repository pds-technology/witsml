...
namespace PDS.WITSMLstudio.Store.Data.Logs
{
    ...
    public class Log131MessageDataAdapter : MessageDataAdapter<Log>, IWitsml131Configuration    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Log131MessageDataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        [ImportingConstructor]
        public Log131MessageDataAdapter(IContainer container)
            : base(container, ObjectNames.Log131)
        {
