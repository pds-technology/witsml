...
namespace PDS.WITSMLstudio
{
    ...
    public class Export200Attribute : ExportAttribute
    {
        ...
        public Export200Attribute(string contractName) : base(new ObjectName(contractName, ObjectFamilies.Witsml, Version))
        {
        }
        ...
        public Export200Attribute(string contractName, Type contractType) : base(new ObjectName(contractName, ObjectFamilies.Witsml, Version), contractType)
        {
        }
    }
}
