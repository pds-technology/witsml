...
namespace PDS.WITSMLstudio
{
    ...
    public class Export131Attribute : ExportAttribute
    {
        ...
        public Export131Attribute(string contractName) : base(new ObjectName(contractName, ObjectFamilies.Witsml, Version))
        {
        }
        ...
        public Export131Attribute(string contractName, Type contractType) : base(new ObjectName(contractName, ObjectFamilies.Witsml, Version), contractType)
        {
        }
    }
}
