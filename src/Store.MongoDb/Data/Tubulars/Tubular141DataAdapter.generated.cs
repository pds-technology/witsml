...
namespace PDS.WITSMLstudio.Store.Data.Tubulars
{
    ...
    public partial class Tubular141DataAdapter : MongoDbDataAdapter<Tubular>, IWitsml141Configuration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Tubular141DataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="databaseProvider">The database provider.</param>
        [ImportingConstructor]
        public Tubular141DataAdapter(IContainer container, IDatabaseProvider databaseProvider)
            : base(container, databaseProvider, ObjectNames.Tubular141)
        {
