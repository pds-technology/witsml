...
namespace PDS.WITSMLstudio.Store.Data.DepthRegImages
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MongoDbDataAdapter{DepthRegImage}" />
    [Export(typeof(IWitsmlDataAdapter<DepthRegImage>))]
    [Export200(ObjectTypes.DepthRegImage, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class DepthRegImage200DataAdapter : MongoDbDataAdapter<DepthRegImage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepthRegImage200DataAdapter" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets an <see cref="IQueryable{DepthRegImage}" /> instance to by used by the GetAll method.
        /// </summary>
        /// <param name="parentUri">The parent URI.</param>
        /// <returns>An executable query.</returns>
        protected override IQueryable<DepthRegImage> GetAllQuery(EtpUri? parentUri)
        {
