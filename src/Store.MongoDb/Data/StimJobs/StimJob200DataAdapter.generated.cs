...
{
    /// <summary>
    /// Data adapter that encapsulates CRUD functionality for <see cref="StimJob" />
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MongoDbDataAdapter{StimJob}" />
    [Export(typeof(IWitsmlDataAdapter<StimJob>))]
    [Export200(ObjectTypes.StimJob, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class StimJob200DataAdapter : MongoDbDataAdapter<StimJob>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StimJob200DataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="databaseProvider">The database provider.</param>
        [ImportingConstructor]
        public StimJob200DataAdapter(IContainer container, IDatabaseProvider databaseProvider)
            : base(container, databaseProvider, ObjectNames.StimJob200, ObjectTypes.Uuid)
        {
