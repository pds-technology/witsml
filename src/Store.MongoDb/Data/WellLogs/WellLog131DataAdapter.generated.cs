...
namespace PDS.WITSMLstudio.Store.Data.WellLogs
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MongoDbDataAdapter{WellLog}" />
    ...
    public partial class WellLog131DataAdapter : MongoDbDataAdapter<WellLog>, IWitsml131Configuration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WellLog131DataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="databaseProvider">The database provider.</param>
        [ImportingConstructor]
        public WellLog131DataAdapter(IContainer container, IDatabaseProvider databaseProvider)
            : base(container, databaseProvider, ObjectNames.WellLog131)
        {
        ...
        public override List<WellLog> GetAll(EtpUri? parentUri)
        {
            Logger.DebugFormat("Fetching all WellLogs; Parent URI: {0}", parentUri);
        ...
        /// <summary>
        /// Gets an <see cref="IQueryable{WellLog}" /> instance to by used by the GetAll method.
        /// </summary>
        /// <param name="parentUri">The parent URI.</param>
        /// <returns>An executable query.</returns>
        protected override IQueryable<WellLog> GetAllQuery(EtpUri? parentUri)
        {
