...
namespace PDS.WITSMLstudio.Store.Data.CementJobs
{
    ...
    public partial class CementJob141DataAdapter : MongoDbDataAdapter<CementJob>, IWitsml141Configuration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CementJob141DataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="databaseProvider">The database provider.</param>
        [ImportingConstructor]
        public CementJob141DataAdapter(IContainer container, IDatabaseProvider databaseProvider)
            : base(container, databaseProvider, ObjectNames.CementJob141)
        {
