...
namespace PDS.WITSMLstudio.Store.Data.OpsReports
{
    ...
    [Export131(ObjectTypes.OpsReport, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class OpsReport131DataAdapter : MongoDbDataAdapter<OpsReport>, IWitsml131Configuration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpsReport131DataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="databaseProvider">The database provider.</param>
        [ImportingConstructor]
        public OpsReport131DataAdapter(IContainer container, IDatabaseProvider databaseProvider)
            : base(container, databaseProvider, ObjectNames.OpsReport131)
        {
