...
namespace PDS.WITSMLstudio.Store.Data.ToolErrorModels
{
    ...
    [Export200(ObjectTypes.ToolErrorModel, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class ToolErrorModel200DataAdapter : MongoDbDataAdapter<ToolErrorModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolErrorModel200DataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="databaseProvider">The database provider.</param>
        [ImportingConstructor]
        public ToolErrorModel200DataAdapter(IContainer container, IDatabaseProvider databaseProvider)
            : base(container, databaseProvider, ObjectNames.ToolErrorModel200, ObjectTypes.Uuid)
        {
