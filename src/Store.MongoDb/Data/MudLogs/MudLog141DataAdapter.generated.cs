...
namespace PDS.WITSMLstudio.Store.Data.MudLogs
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.MudLogs.MudLogDataAdapter{MudLog,GeologyInterval}" />
    [Export(typeof(IWitsml141Configuration))]
    [Export(typeof(IWitsmlDataAdapter<MudLog>))]
    [Export141(ObjectTypes.MudLog, typeof(IWitsmlDataAdapter))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class MudLog141DataAdapter : MudLogDataAdapter<MudLog, GeologyInterval>, IWitsml141Configuration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MudLog141DataAdapter" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="databaseProvider">The database provider.</param>
        [ImportingConstructor]
        public MudLog141DataAdapter(IContainer container, IDatabaseProvider databaseProvider)
            : base(container, databaseProvider, ObjectNames.MudLog141)
        {
        ...
        public override List<MudLog> GetAll(EtpUri? parentUri)
        {
            Logger.DebugFormat("Fetching all MudLogs; Parent URI: {0}", parentUri);
        ...
        /// <summary>
        /// Gets an <see cref="IQueryable{MudLog}" /> instance to by used by the GetAll method.
        /// </summary>
        /// <param name="parentUri">The parent URI.</param>
        /// <returns>An executable query.</returns>
        protected override IQueryable<MudLog> GetAllQuery(EtpUri? parentUri)
        {
