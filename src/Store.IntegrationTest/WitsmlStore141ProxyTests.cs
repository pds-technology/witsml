...
namespace PDS.WITSMLstudio.Store
{
    ...
    public class WitsmlStore141ProxyTests
    {
        ...
        [TestMethod]
        public void WITSMLWebServiceConnection_Can_Query_Well_OptionsIn_RequestObjectSelectionCapability()
        {
            // Add Well
            _devKit.Proxy.Write(_devKit.New<WellList>(x => x.Well = _devKit.List(_well1)));
            _devKit.Proxy.Write(_devKit.New<WellList>(x => x.Well = _devKit.List(_well2)));
            ...
            // Get Well by Name
            var query = _devKit.Query<WellList>();
            var result = _devKit.Proxy.Read(query, OptionsIn.RequestObjectSelectionCapability.True);
        ...
        public void WITSMLWebServiceConnection_Can_Query_Wellbore_By_Uid()
        {
            ...
            // Get Wellbore by Uid
            var query = _devKit.Query<WellboreList>();
            query.Wellbore = _devKit.One<Wellbore>(x => { x.Uid = _wellbore1.Uid; x.UidWell = _wellbore1.UidWell; });
        ...
        public void WITSMLWebServiceConnection_Can_Write_And_Query_All_Log_Headers()
        {
            ...
            var result = _devKit.Proxy.Read(query, OptionsIn.ReturnElements.HeaderOnly);
        ...
        public void WITSMLWebServiceConnection_Can_Write_Bulk_Log_Data()
        {
            ...
            var firstFactor = _log1.LogData[0].Data.Skip(1).ToList();

            _log1.LogData[0].Data.Clear();
