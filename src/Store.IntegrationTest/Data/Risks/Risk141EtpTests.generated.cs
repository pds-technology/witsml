...
{
    [TestClass]
    public partial class Risk141EtpTests : Risk141TestBase
    {
        public Risk141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void Risk141_Ensure_Creates_Risk_With_Default_Values()
        {
            DevKit.EnsureAndAssert<RiskList, Risk>(Risk);
        }

        [TestMethod]
        public async Task Risk141_GetResources_Can_Get_All_Risk_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Risk141_PutObject_Can_Add_Risk()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Risk141_PutObject_Can_Update_Risk()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var updateDataObject = CreateDataObject<RiskList, Risk>(uri, result);
            ...
            result = Parse<RiskList, Risk>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task Risk141_DeleteObject_Can_Delete_Risk()
        {
            AddParents();
            await RequestSessionAndAssert();
