...
{
    [TestClass]
    public partial class Risk131EtpTests : Risk131TestBase
    {
        public Risk131EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void Risk131_Ensure_Creates_Risk_With_Default_Values()
        {
            DevKit.EnsureAndAssert<RiskList, Risk>(Risk);
        }

        [TestMethod]
        public async Task Risk131_GetResources_Can_Get_All_Risk_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Risk131_PutObject_Can_Update_Risk()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Risk131_DeleteObject_Can_Delete_Risk()
        {
            AddParents();
            await RequestSessionAndAssert();
