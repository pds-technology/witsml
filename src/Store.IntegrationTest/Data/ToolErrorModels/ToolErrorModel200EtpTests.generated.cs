...
{
    [TestClass]
    public partial class ToolErrorModel200EtpTests : ToolErrorModel200TestBase
    {
        public ToolErrorModel200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void ToolErrorModel200_Ensure_Creates_ToolErrorModel_With_Default_Values()
        {
            DevKit.EnsureAndAssert(ToolErrorModel);
        }

        [TestMethod]
        public async Task ToolErrorModel200_GetResources_Can_Get_All_ToolErrorModel_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task ToolErrorModel200_PutObject_Can_Add_ToolErrorModel()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, ToolErrorModel);
            ...
            var result = Parse<ToolErrorModel>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task ToolErrorModel200_PutObject_Can_Update_ToolErrorModel()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            ToolErrorModel.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<ToolErrorModel>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task ToolErrorModel200_DeleteObject_Can_Delete_ToolErrorModel()
        {
            AddParents();
            await RequestSessionAndAssert();
