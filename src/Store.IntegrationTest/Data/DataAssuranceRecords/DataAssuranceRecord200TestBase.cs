...
{
    /// <summary>
    /// DataAssuranceRecord200TestBase
    /// </summary>
    public partial class DataAssuranceRecord200TestBase
    {
        protected override void OnTestSetUp()
        {
            ...
            DataAssuranceRecord.PolicyId = DevKit.Name();
            DataAssuranceRecord.ReferencedData = DevKit.DataObjectReference(ObjectTypes.Well, DevKit.Name(), DevKit.Uid());
        }
    }
}
