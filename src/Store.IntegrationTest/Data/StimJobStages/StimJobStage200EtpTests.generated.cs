...
{
    [TestClass]
    public partial class StimJobStage200EtpTests : StimJobStage200TestBase
    {
        public StimJobStage200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void StimJobStage200_Ensure_Creates_StimJobStage_With_Default_Values()
        {
            DevKit.EnsureAndAssert(StimJobStage);
        }

        [TestMethod]
        public async Task StimJobStage200_GetResources_Can_Get_All_StimJobStage_Resources()
        {
            AddParents();
            DevKit.AddAndAssert(StimJobStage);
            await RequestSessionAndAssert();

            var uri = StimJobStage.GetUri();
        ...
        [TestMethod]
        public async Task StimJobStage200_PutObject_Can_Add_StimJobStage()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, StimJobStage);
            ...
            var result = Parse<StimJobStage>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task StimJobStage200_PutObject_Can_Update_StimJobStage()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            StimJobStage.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<StimJobStage>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task StimJobStage200_DeleteObject_Can_Delete_StimJobStage()
        {
            AddParents();
            await RequestSessionAndAssert();
