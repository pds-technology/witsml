...
{
    [TestClass]
    public partial class Attachment141EtpTests : Attachment141TestBase
    {
        public Attachment141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void Attachment141_Ensure_Creates_Attachment_With_Default_Values()
        {
            DevKit.EnsureAndAssert<AttachmentList, Attachment>(Attachment);
        }

        [TestMethod]
        public async Task Attachment141_GetResources_Can_Get_All_Attachment_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Attachment141_PutObject_Can_Add_Attachment()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject<AttachmentList, Attachment>(uri, Attachment);
        ...
        [TestMethod]
        public async Task Attachment141_PutObject_Can_Update_Attachment()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var updateDataObject = CreateDataObject<AttachmentList, Attachment>(uri, result);
