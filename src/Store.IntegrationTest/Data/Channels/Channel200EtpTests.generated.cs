...
{
    [TestClass]
    public partial class Channel200EtpTests : Channel200TestBase
    {
        public Channel200EtpTests()
            : base(true)
        {
        }
        ...
        [TestMethod]
        public async Task Channel200_GetResources_Can_Get_All_Channel_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(Channel.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task Channel200_PutObject_Can_Add_Channel()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Channel200_DeleteObject_Can_Delete_Channel()
        {
            AddParents();
            await RequestSessionAndAssert();
