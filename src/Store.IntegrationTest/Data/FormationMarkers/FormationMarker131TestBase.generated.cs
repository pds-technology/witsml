...
{
    public abstract partial class FormationMarker131TestBase : IntegrationTestFixtureBase<DevKit131Aspect>
    {
        ...
        protected FormationMarker131TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
