...
{
    [TestClass]
    public partial class Trajectory131EtpTests : Trajectory131TestBase
    {
        public Trajectory131EtpTests()
            : base(true)
        {
        }
        ...
        [TestMethod]
        public async Task Trajectory131_GetResources_Can_Get_All_Trajectory_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Trajectory131_PutObject_Can_Update_Trajectory()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Trajectory131_DeleteObject_Can_Delete_Trajectory()
        {
            AddParents();
            await RequestSessionAndAssert();
