...
{
    [TestClass]
    public partial class MudLogReport200EtpTests : MudLogReport200TestBase
    {
        public MudLogReport200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void MudLogReport200_Ensure_Creates_MudLogReport_With_Default_Values()
        {
            DevKit.EnsureAndAssert(MudLogReport);
        }

        [TestMethod]
        public async Task MudLogReport200_GetResources_Can_Get_All_MudLogReport_Resources()
        {
            AddParents();
            DevKit.AddAndAssert(MudLogReport);
            await RequestSessionAndAssert();

            var uri = MudLogReport.GetUri();
            var parentUri = uri.Parent;

            await GetResourcesAndAssert(MudLogReport.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task MudLogReport200_PutObject_Can_Add_MudLogReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, MudLogReport);
            ...
            var result = Parse<MudLogReport>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task MudLogReport200_PutObject_Can_Update_MudLogReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            MudLogReport.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<MudLogReport>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task MudLogReport200_DeleteObject_Can_Delete_MudLogReport()
        {
            AddParents();
            await RequestSessionAndAssert();
