...
{
    [TestClass]
    public partial class StimJob200EtpTests : StimJob200TestBase
    {
        public StimJob200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void StimJob200_Ensure_Creates_StimJob_With_Default_Values()
        {
            DevKit.EnsureAndAssert(StimJob);
        }

        [TestMethod]
        public async Task StimJob200_GetResources_Can_Get_All_StimJob_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(StimJob.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task StimJob200_PutObject_Can_Add_StimJob()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, StimJob);
            ...
            var result = Parse<StimJob>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task StimJob200_PutObject_Can_Update_StimJob()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            StimJob.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<StimJob>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task StimJob200_DeleteObject_Can_Delete_StimJob()
        {
            AddParents();
            await RequestSessionAndAssert();
