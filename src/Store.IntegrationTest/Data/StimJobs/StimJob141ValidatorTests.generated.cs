...
namespace PDS.WITSMLstudio.Store.Data.StimJobs
{
    ...
    public partial class StimJob141ValidatorTests : StimJob141TestBase
    {
        ...
        public static readonly string QueryInvalidPluralRoot =
            "<stimJob xmlns=\"http://www.witsml.org/schemas/1series\" version=\"1.4.1.1\">" + Environment.NewLine +
            "  <stimJob>" + Environment.NewLine +
            "    <name>Test Plural Root Element</name>" + Environment.NewLine +
            "  </stimJob>" + Environment.NewLine +
            "</stimJob>";

        [TestMethod]
        public void StimJob141Validator_GetFromStore_Error_401_No_Plural_Root_Element()
        {
            var response = DevKit.GetFromStore(ObjectTypes.StimJob, QueryInvalidPluralRoot, null, null);
            Assert.AreEqual((short)ErrorCodes.MissingPluralRootElement, response.Result);
        }

        [TestMethod]
        public void StimJob141Validator_AddToStore_Error_401_No_Plural_Root_Element()
        {
            var response = DevKit.AddToStore(ObjectTypes.StimJob, QueryInvalidPluralRoot, null, null);
            Assert.AreEqual((short)ErrorCodes.MissingPluralRootElement, response?.Result);
        }

        [TestMethod]
        public void StimJob141Validator_UpdateInStore_Error_401_No_Plural_Root_Element()
        {
            var response = DevKit.UpdateInStore(ObjectTypes.StimJob, QueryInvalidPluralRoot, null, null);
            Assert.AreEqual((short)ErrorCodes.MissingPluralRootElement, response?.Result);
        }
        ...
        [TestMethod]
        public void StimJob141Validator_GetFromStore_Error_403_RequestObjectSelectionCapability_True_MissingNamespace()
        {
            var response = DevKit.GetFromStore(ObjectTypes.StimJob, QueryMissingNamespace, null, optionsIn: OptionsIn.RequestObjectSelectionCapability.True);
        ...
        [TestMethod]
        public void StimJob141Validator_GetFromStore_Error_403_RequestObjectSelectionCapability_None_BadNamespace()
        {
            var response = DevKit.GetFromStore(ObjectTypes.StimJob, QueryInvalidNamespace, null, optionsIn: OptionsIn.RequestObjectSelectionCapability.None);
            Assert.AreEqual((short)ErrorCodes.MissingDefaultWitsmlNamespace, response.Result);
        }
        ...
        [TestMethod]
        public void StimJob141Validator_UpdateInStore_Error_407_StimJob_Missing_Witsml_Object_Type()
        {
            AddParents();
            DevKit.AddAndAssert<StimJobList, StimJob>(StimJob);
            var response = DevKit.Update<StimJobList, StimJob>(StimJob, string.Empty);
        ...
        [TestMethod]
        public void StimJob141Validator_UpdateInStore_Error_408_StimJob_Empty_QueryIn()
        {
            var response = DevKit.UpdateInStore(ObjectTypes.StimJob, string.Empty, null, null);
            Assert.IsNotNull(response);
        ...
        [TestMethod]
        public void StimJob141Validator_UpdateInStore_Error_415_StimJob_Update_Without_Specifing_UID()
        {
            AddParents();
            DevKit.AddAndAssert<StimJobList, StimJob>(StimJob);
            StimJob.Uid = string.Empty;
            DevKit.UpdateAndAssert<StimJobList, StimJob>(StimJob, ErrorCodes.DataObjectUidMissing);
        }
        ...
        public void StimJob141Validator_GetFromStore_Error_438_StimJob_Recurring_Elements_Have_Inconsistent_Selection()
        {
            ...
            var results = DevKit.GetFromStore(ObjectTypes.StimJob, queryXml, null, null);
        ...
        [TestMethod]
        public void StimJob141Validator_UpdateInStore_Error_444_StimJob_Updating_More_Than_One_Data_Object()
        {
            AddParents();
            DevKit.AddAndAssert<StimJobList, StimJob>(StimJob);
            ...
            var response = DevKit.UpdateInStore(ObjectTypes.StimJob, updateXml, null, null);
        ...
        public void StimJob141Validator_UpdateInStore_Error_445_StimJob_Empty_New_Element()
        {
            ...
            DevKit.UpdateAndAssert(StimJob, ErrorCodes.EmptyNewElementsOrAttributes);
        }
        ...
        public void StimJob141Validator_AddToStore_Error_464_StimJob_Uid_Not_Unique()
        {
            ...
            DevKit.AddAndAssert(StimJob, ErrorCodes.ChildUidNotUnique);
        }
        ...
        public void StimJob141Validator_UpdateInStore_Error_464_StimJob_Uid_Not_Unique()
        {
            ...
            DevKit.UpdateAndAssert(StimJob, ErrorCodes.ChildUidNotUnique);
        }
        ...
        public void StimJob141Validator_AddToStore_Error_478_StimJob_Parent_Uid_Case_Not_Matching()
        {
            ...
            StimJob.UidWell = Well.Uid.ToLower();

            DevKit.AddAndAssert(StimJob, ErrorCodes.IncorrectCaseParentUid);
        }
        ...
        [TestMethod]
        public void StimJob141Validator_UpdateInStore_Error_483_StimJob_Update_With_Non_Conforming_Template()
        {
            AddParents();
            DevKit.AddAndAssert<StimJobList, StimJob>(StimJob);
            var response = DevKit.UpdateInStore(ObjectTypes.StimJob, QueryEmptyRoot, null, null);
