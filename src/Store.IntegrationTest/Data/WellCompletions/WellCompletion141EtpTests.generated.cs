...
{
    [TestClass]
    public partial class WellCompletion141EtpTests : WellCompletion141TestBase
    {
        public WellCompletion141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void WellCompletion141_Ensure_Creates_WellCompletion_With_Default_Values()
        {
            DevKit.EnsureAndAssert<WellCompletionList, WellCompletion>(WellCompletion);
        }

        [TestMethod]
        public async Task WellCompletion141_GetResources_Can_Get_All_WellCompletion_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task WellCompletion141_PutObject_Can_Add_WellCompletion()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task WellCompletion141_DeleteObject_Can_Delete_WellCompletion()
        {
            AddParents();
            await RequestSessionAndAssert();
