...
{
    public abstract partial class WellCompletion200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected WellCompletion200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
