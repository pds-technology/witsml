...
{
    [TestClass]
    public partial class CementJob141EtpTests : CementJob141TestBase
    {
        public CementJob141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void CementJob141_Ensure_Creates_CementJob_With_Default_Values()
        {
            DevKit.EnsureAndAssert<CementJobList, CementJob>(CementJob);
        }

        [TestMethod]
        public async Task CementJob141_GetResources_Can_Get_All_CementJob_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task CementJob141_PutObject_Can_Add_CementJob()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task CementJob141_PutObject_Can_Update_CementJob()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task CementJob141_DeleteObject_Can_Delete_CementJob()
        {
            AddParents();
            await RequestSessionAndAssert();
