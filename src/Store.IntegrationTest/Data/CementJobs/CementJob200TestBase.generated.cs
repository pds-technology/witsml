...
{
    public abstract partial class CementJob200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected CementJob200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
        ...
        protected override void PrepareData()
        {
            ...
            {
                Uuid = DevKit.Uid(),
                Citation = DevKit.Citation("CementJob"),
                Wellbore = DevKit.DataObjectReference(Wellbore),
                SchemaVersion = EtpUris.GetUriFamily(typeof(CementJob)).Version,
            };
