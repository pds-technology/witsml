...
{
    [TestClass]
    public partial class WellLog131EtpTests : WellLog131TestBase
    {
        public WellLog131EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void WellLog131_Ensure_Creates_WellLog_With_Default_Values()
        {
            DevKit.EnsureAndAssert<WellLogList, WellLog>(WellLog);
        }
        ...
        [TestMethod]
        public async Task WellLog131_DeleteObject_Can_Delete_WellLog()
        {
            AddParents();
            await RequestSessionAndAssert();
