...
{
    [TestClass]
    public partial class Tubular200EtpTests : Tubular200TestBase
    {
        public Tubular200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void Tubular200_Ensure_Creates_Tubular_With_Default_Values()
        {
            DevKit.EnsureAndAssert(Tubular);
        }

        [TestMethod]
        public async Task Tubular200_GetResources_Can_Get_All_Tubular_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(Tubular.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task Tubular200_PutObject_Can_Add_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, Tubular);
            ...
            var result = Parse<Tubular>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task Tubular200_PutObject_Can_Update_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            Tubular.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<Tubular>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task Tubular200_DeleteObject_Can_Delete_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
