...
{
    [TestClass]
    public partial class Tubular131EtpTests : Tubular131TestBase
    {
        public Tubular131EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void Tubular131_Ensure_Creates_Tubular_With_Default_Values()
        {
            DevKit.EnsureAndAssert<TubularList, Tubular>(Tubular);
        }

        [TestMethod]
        public async Task Tubular131_GetResources_Can_Get_All_Tubular_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Tubular131_PutObject_Can_Add_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Tubular131_PutObject_Can_Update_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Tubular131_DeleteObject_Can_Delete_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
