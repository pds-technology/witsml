...
{
    [TestClass]
    public partial class Tubular141EtpTests : Tubular141TestBase
    {
        public Tubular141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void Tubular141_Ensure_Creates_Tubular_With_Default_Values()
        {
            DevKit.EnsureAndAssert<TubularList, Tubular>(Tubular);
        }

        [TestMethod]
        public async Task Tubular141_GetResources_Can_Get_All_Tubular_Resources()
        {
            AddParents();
            DevKit.AddAndAssert<TubularList, Tubular>(Tubular);
            await RequestSessionAndAssert();

            var uri = Tubular.GetUri();
        ...
        [TestMethod]
        public async Task Tubular141_PutObject_Can_Add_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject<TubularList, Tubular>(uri, Tubular);
            ...
            var result = Parse<TubularList, Tubular>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task Tubular141_PutObject_Can_Update_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var updateDataObject = CreateDataObject<TubularList, Tubular>(uri, result);
            ...
            result = Parse<TubularList, Tubular>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task Tubular141_DeleteObject_Can_Delete_Tubular()
        {
            AddParents();
            await RequestSessionAndAssert();
