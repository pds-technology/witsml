...
{
    [TestClass]
    public partial class WellboreMarker200EtpTests : WellboreMarker200TestBase
    {
        public WellboreMarker200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void WellboreMarker200_Ensure_Creates_WellboreMarker_With_Default_Values()
        {
            DevKit.EnsureAndAssert(WellboreMarker);
        }

        [TestMethod]
        public async Task WellboreMarker200_GetResources_Can_Get_All_WellboreMarker_Resources()
        {
            AddParents();
            DevKit.AddAndAssert(WellboreMarker);
            await RequestSessionAndAssert();

            var uri = WellboreMarker.GetUri();
            var parentUri = uri.Parent;

            await GetResourcesAndAssert(WellboreMarker.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task WellboreMarker200_PutObject_Can_Add_WellboreMarker()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, WellboreMarker);
            ...
            var result = Parse<WellboreMarker>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task WellboreMarker200_PutObject_Can_Update_WellboreMarker()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            WellboreMarker.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<WellboreMarker>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task WellboreMarker200_DeleteObject_Can_Delete_WellboreMarker()
        {
            AddParents();
            await RequestSessionAndAssert();
