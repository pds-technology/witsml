...
{
    [TestClass]
    public partial class Target141EtpTests : Target141TestBase
    {
        public Target141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void Target141_Ensure_Creates_Target_With_Default_Values()
        {
            DevKit.EnsureAndAssert<TargetList, Target>(Target);
        }

        [TestMethod]
        public async Task Target141_GetResources_Can_Get_All_Target_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Target141_PutObject_Can_Add_Target()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject<TargetList, Target>(uri, Target);
            ...
            var result = Parse<TargetList, Target>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task Target141_PutObject_Can_Update_Target()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var updateDataObject = CreateDataObject<TargetList, Target>(uri, result);
            ...
            result = Parse<TargetList, Target>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task Target141_DeleteObject_Can_Delete_Target()
        {
            AddParents();
            await RequestSessionAndAssert();
