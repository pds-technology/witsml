...
namespace PDS.WITSMLstudio.Store.Data.Targets
{
    ...
    public partial class Target141StoreTests : Target141TestBase
    {
        ...
        [TestMethod]
        public void Target141DataAdapter_GetFromStore_Can_Get_Target()
        {
            AddParents();
            DevKit.AddAndAssert<TargetList, Target>(Target);
            DevKit.GetAndAssert<TargetList, Target>(Target);
       }

        [TestMethod]
        public void Target141DataAdapter_AddToStore_Can_Add_Target()
        {
            AddParents();
            DevKit.AddAndAssert<TargetList, Target>(Target);
        }
        ...
        [TestMethod]
        public void Target141DataAdapter_UpdateInStore_Can_Update_Target()
        {
            AddParents();
            DevKit.AddAndAssert<TargetList, Target>(Target);
            DevKit.UpdateAndAssert<TargetList, Target>(Target);
            DevKit.GetAndAssert<TargetList, Target>(Target);
        }

        [TestMethod]
        public void Target141DataAdapter_DeleteFromStore_Can_Delete_Target()
        {
            AddParents();
            DevKit.AddAndAssert<TargetList, Target>(Target);
            DevKit.DeleteAndAssert<TargetList, Target>(Target);
            DevKit.GetAndAssert<TargetList, Target>(Target, isNotNull: false);
        }

        [TestMethod]
        public void Target141WitsmlStore_GetFromStore_Can_Transform_Target()
        {
            AddParents();
            DevKit.AddAndAssert<TargetList, Target>(Target);
            ...
            var query = DevKit.List(DevKit.CreateQuery(Target));
            DevKit.SetupParameters<TargetList, Target>(query, ObjectTypes.Target, out typeIn, out queryIn);
        ...
        [TestMethod]
        public void Target141DataAdapter_AddToStore_Creates_ChangeLog()
        {
            AddParents();

            DevKit.AddAndAssert<TargetList, Target>(Target);

            var result = DevKit.GetAndAssert<TargetList, Target>(Target);
        ...
        [TestMethod]
        public void Target141DataAdapter_UpdateInStore_Updates_ChangeLog()
        {
            AddParents();

            DevKit.AddAndAssert<TargetList, Target>(Target);

            // Update the Target141
            Target.Name = "Change";
            DevKit.UpdateAndAssert(Target);
        ...
        [TestMethod]
        public void Target141DataAdapter_DeleteFromStore_Updates_ChangeLog()
        {
            AddParents();

            DevKit.AddAndAssert<TargetList, Target>(Target);

            // Delete the Target141
            DevKit.DeleteAndAssert(Target);

            var expectedHistoryCount = 2;
            var expectedChangeType = ChangeInfoType.delete;
            DevKit.AssertChangeLog(Target, expectedHistoryCount, expectedChangeType);
        }

        [TestMethod]
        public void Target141DataAdapter_ChangeLog_Tracks_ChangeHistory_For_Add_Update_Delete()
        {
            AddParents();
            ...
            result = DevKit.GetAndAssert<TargetList, Target>(Target);
        ...
        [TestMethod]
        public void Target141DataAdapter_GetFromStore_Filter_ExtensionNameValue()
        {
            AddParents();
            ...
            var queryXml = string.Format(BasicXMLTemplate, Target.UidWell, Target.UidWellbore, Target.Uid, extValueQuery);
            var result = DevKit.Query<TargetList, Target>(ObjectTypes.Target, queryXml, null, OptionsIn.ReturnElements.Requested);
            Assert.IsNotNull(result);
            Assert.AreEqual(1, result.Count);

            var resultTarget = result[0];
            Assert.IsNotNull(resultTarget);

            var commonData = resultTarget.CommonData;
            ...
            queryXml = string.Format(BasicXMLTemplate, Target.UidWell, Target.UidWellbore, Target.Uid, extValueQuery);
            result = DevKit.Query<TargetList, Target>(ObjectTypes.Target, queryXml, null, OptionsIn.ReturnElements.Requested);
            Assert.IsNotNull(result);
            Assert.AreEqual(1, result.Count);

            resultTarget = result[0];
            Assert.IsNotNull(resultTarget);

            commonData = resultTarget.CommonData;
            Assert.IsNotNull(commonData);
            Assert.AreEqual(1, commonData.ExtensionNameValue.Count);
        ...
        [TestMethod]
        public void Target141DataAdapter_ChangeLog_Syncs_Target_Name_Changes()
        {
            AddParents();
            ...
            // Assert that all Target names match corresponding changeLog names
            DevKit.AssertChangeLogNames(Target);

            // Update the Target141 names
            Target.Name = "Change";
            Target.NameWell = "Well Name Change";

            Target.NameWellbore = "Wellbore Name Change";
