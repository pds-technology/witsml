...
{
    [TestClass]
    public partial class Target131EtpTests : Target131TestBase
    {
        public Target131EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void Target131_Ensure_Creates_Target_With_Default_Values()
        {
            DevKit.EnsureAndAssert<TargetList, Target>(Target);
        }

        [TestMethod]
        public async Task Target131_GetResources_Can_Get_All_Target_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Target131_PutObject_Can_Add_Target()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Target131_PutObject_Can_Update_Target()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Target131_DeleteObject_Can_Delete_Target()
        {
            AddParents();
            await RequestSessionAndAssert();
