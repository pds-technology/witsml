...
{
    [TestClass]
    public partial class SurveyProgram200EtpTests : SurveyProgram200TestBase
    {
        public SurveyProgram200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void SurveyProgram200_Ensure_Creates_SurveyProgram_With_Default_Values()
        {
            DevKit.EnsureAndAssert(SurveyProgram);
        }

        [TestMethod]
        public async Task SurveyProgram200_GetResources_Can_Get_All_SurveyProgram_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(SurveyProgram.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task SurveyProgram200_PutObject_Can_Add_SurveyProgram()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, SurveyProgram);
            ...
            var result = Parse<SurveyProgram>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task SurveyProgram200_PutObject_Can_Update_SurveyProgram()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            SurveyProgram.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<SurveyProgram>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task SurveyProgram200_DeleteObject_Can_Delete_SurveyProgram()
        {
            AddParents();
            await RequestSessionAndAssert();
