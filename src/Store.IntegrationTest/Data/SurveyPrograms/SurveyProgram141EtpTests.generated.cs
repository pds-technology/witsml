...
{
    [TestClass]
    public partial class SurveyProgram141EtpTests : SurveyProgram141TestBase
    {
        public SurveyProgram141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void SurveyProgram141_Ensure_Creates_SurveyProgram_With_Default_Values()
        {
            DevKit.EnsureAndAssert<SurveyProgramList, SurveyProgram>(SurveyProgram);
        }

        [TestMethod]
        public async Task SurveyProgram141_GetResources_Can_Get_All_SurveyProgram_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task SurveyProgram141_PutObject_Can_Add_SurveyProgram()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task SurveyProgram141_PutObject_Can_Update_SurveyProgram()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task SurveyProgram141_DeleteObject_Can_Delete_SurveyProgram()
        {
            AddParents();
            await RequestSessionAndAssert();
