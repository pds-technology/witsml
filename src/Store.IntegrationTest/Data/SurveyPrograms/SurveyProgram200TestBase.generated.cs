...
{
    public abstract partial class SurveyProgram200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected SurveyProgram200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
