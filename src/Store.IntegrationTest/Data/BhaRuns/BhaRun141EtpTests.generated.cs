...
{
    [TestClass]
    public partial class BhaRun141EtpTests : BhaRun141TestBase
    {
        public BhaRun141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void BhaRun141_Ensure_Creates_BhaRun_With_Default_Values()
        {
            DevKit.EnsureAndAssert<BhaRunList, BhaRun>(BhaRun);
        }

        [TestMethod]
        public async Task BhaRun141_GetResources_Can_Get_All_BhaRun_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task BhaRun141_PutObject_Can_Add_BhaRun()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task BhaRun141_PutObject_Can_Update_BhaRun()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task BhaRun141_DeleteObject_Can_Delete_BhaRun()
        {
            AddParents();
            await RequestSessionAndAssert();
