...
{
    [TestClass]
    public partial class BhaRun200EtpTests : BhaRun200TestBase
    {
        public BhaRun200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void BhaRun200_Ensure_Creates_BhaRun_With_Default_Values()
        {
            DevKit.EnsureAndAssert(BhaRun);
        }

        [TestMethod]
        public async Task BhaRun200_GetResources_Can_Get_All_BhaRun_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(BhaRun.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task BhaRun200_PutObject_Can_Add_BhaRun()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, BhaRun);
            ...
            var result = Parse<BhaRun>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task BhaRun200_PutObject_Can_Update_BhaRun()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            BhaRun.ExtensionNameValue = new List<ExtensionNameValue>() {env};
        ...
        [TestMethod]
        public async Task BhaRun200_DeleteObject_Can_Delete_BhaRun()
        {
            AddParents();
            await RequestSessionAndAssert();
