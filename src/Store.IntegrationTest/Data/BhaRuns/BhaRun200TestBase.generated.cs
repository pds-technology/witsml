...
{
    public abstract partial class BhaRun200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected BhaRun200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
        ...
        protected override void PrepareData()
        {
            ...
            {
                Uuid = DevKit.Uid(),
                Citation = DevKit.Citation("BhaRun"),
                Wellbore = DevKit.DataObjectReference(Wellbore),
                SchemaVersion = EtpUris.GetUriFamily(typeof(BhaRun)).Version,
            };
