...
{
    [TestClass]
    public partial class MudLog131EtpTests : MudLog131TestBase
    {
        public MudLog131EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void MudLog131_Ensure_Creates_MudLog_With_Default_Values()
        {
            DevKit.EnsureAndAssert<MudLogList, MudLog>(MudLog);
        }

        [TestMethod]
        public async Task MudLog131_GetResources_Can_Get_All_MudLog_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task MudLog131_PutObject_Can_Add_MudLog()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task MudLog131_PutObject_Can_Update_MudLog()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task MudLog131_DeleteObject_Can_Delete_MudLog()
        {
            AddParents();
            await RequestSessionAndAssert();
