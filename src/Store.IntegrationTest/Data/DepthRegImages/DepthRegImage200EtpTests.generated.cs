...
{
    [TestClass]
    public partial class DepthRegImage200EtpTests : DepthRegImage200TestBase
    {
        public DepthRegImage200EtpTests()
            : base(true)
        {
        }
        ...
        [TestMethod]
        public async Task DepthRegImage200_GetResources_Can_Get_All_DepthRegImage_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(DepthRegImage.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task DepthRegImage200_PutObject_Can_Add_DepthRegImage()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, DepthRegImage);
            ...
            var result = Parse<DepthRegImage>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task DepthRegImage200_PutObject_Can_Update_DepthRegImage()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            DepthRegImage.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<DepthRegImage>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task DepthRegImage200_DeleteObject_Can_Delete_DepthRegImage()
        {
            AddParents();
            await RequestSessionAndAssert();
