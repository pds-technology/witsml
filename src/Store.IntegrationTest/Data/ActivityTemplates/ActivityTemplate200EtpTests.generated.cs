...
namespace PDS.WITSMLstudio.Store.Data.ActivityTemplates
{
    ...
    public partial class ActivityTemplate200EtpTests : ActivityTemplate200TestBase
    {
        ...
        [TestMethod]
        public void ActivityTemplate200_Ensure_Creates_ActivityTemplate_With_Default_Values()
        {
            DevKit.EnsureAndAssert(ActivityTemplate);
        }
        ...
        public async Task ActivityTemplate200_PutObject_Can_Update_ActivityTemplate()
        {
            ...
            ActivityTemplate.ExtensionNameValue = new List<ExtensionNameValue>() {env};
        ...
        [TestMethod]
        public async Task ActivityTemplate200_DeleteObject_Can_Delete_ActivityTemplate()
        {
            AddParents();
            await RequestSessionAndAssert();
