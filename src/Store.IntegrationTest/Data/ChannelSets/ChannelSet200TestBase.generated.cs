...
{
    public abstract partial class ChannelSet200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected ChannelSet200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
        ...
        protected override void PrepareData()
        {
            ...
            ChannelSet = new ChannelSet
            {
                ...
                SchemaVersion = EtpUris.GetUriFamily(typeof(ChannelSet)).Version,
            };
