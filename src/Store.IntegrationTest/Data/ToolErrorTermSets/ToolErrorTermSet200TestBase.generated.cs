...
{
    public abstract partial class ToolErrorTermSet200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected ToolErrorTermSet200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
