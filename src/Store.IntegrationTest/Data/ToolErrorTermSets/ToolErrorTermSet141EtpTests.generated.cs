...
namespace PDS.WITSMLstudio.Store.Data.ToolErrorTermSets
{
    ...
    public partial class ToolErrorTermSet141EtpTests : ToolErrorTermSet141TestBase
    {
        ...
        [TestMethod]
        public void ToolErrorTermSet141_Ensure_Creates_ToolErrorTermSet_With_Default_Values()
        {
            DevKit.EnsureAndAssert<ToolErrorTermSetList, ToolErrorTermSet>(ToolErrorTermSet);
        }

        [TestMethod]
        public async Task ToolErrorTermSet141_GetResources_Can_Get_All_ToolErrorTermSet_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task ToolErrorTermSet141_PutObject_Can_Add_ToolErrorTermSet()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject<ToolErrorTermSetList, ToolErrorTermSet>(uri, ToolErrorTermSet);
            ...
            var result = Parse<ToolErrorTermSetList, ToolErrorTermSet>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task ToolErrorTermSet141_PutObject_Can_Update_ToolErrorTermSet()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var updateDataObject = CreateDataObject<ToolErrorTermSetList, ToolErrorTermSet>(uri, result);
            ...
            result = Parse<ToolErrorTermSetList, ToolErrorTermSet>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task ToolErrorTermSet141_DeleteObject_Can_Delete_ToolErrorTermSet()
        {
            AddParents();
            await RequestSessionAndAssert();
