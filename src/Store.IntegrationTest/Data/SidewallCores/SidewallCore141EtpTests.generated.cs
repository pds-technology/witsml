...
namespace PDS.WITSMLstudio.Store.Data.SidewallCores
{
    ...
    public partial class SidewallCore141EtpTests : SidewallCore141TestBase
    {
        ...
        [TestMethod]
        public void SidewallCore141_Ensure_Creates_SidewallCore_With_Default_Values()
        {
            DevKit.EnsureAndAssert<SidewallCoreList, SidewallCore>(SidewallCore);
        }

        [TestMethod]
        public async Task SidewallCore141_GetResources_Can_Get_All_SidewallCore_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task SidewallCore141_PutObject_Can_Add_SidewallCore()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task SidewallCore141_PutObject_Can_Update_SidewallCore()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task SidewallCore141_DeleteObject_Can_Delete_SidewallCore()
        {
            AddParents();
            await RequestSessionAndAssert();
