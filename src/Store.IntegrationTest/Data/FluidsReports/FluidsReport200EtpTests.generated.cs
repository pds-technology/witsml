...
{
    [TestClass]
    public partial class FluidsReport200EtpTests : FluidsReport200TestBase
    {
        public FluidsReport200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void FluidsReport200_Ensure_Creates_FluidsReport_With_Default_Values()
        {
            DevKit.EnsureAndAssert(FluidsReport);
        }

        [TestMethod]
        public async Task FluidsReport200_GetResources_Can_Get_All_FluidsReport_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(FluidsReport.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task FluidsReport200_PutObject_Can_Add_FluidsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, FluidsReport);
            ...
            var result = Parse<FluidsReport>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task FluidsReport200_PutObject_Can_Update_FluidsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            FluidsReport.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<FluidsReport>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task FluidsReport200_DeleteObject_Can_Delete_FluidsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
