...
namespace PDS.WITSMLstudio.Store.Data.OpsReports
{
    ...
    public partial class OpsReport141StoreTests : OpsReport141TestBase
    {
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_GetFromStore_Can_Get_OpsReport()
        {
            AddParents();
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_AddToStore_Can_Add_OpsReport()
        {
            AddParents();
            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);
        }
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_UpdateInStore_Can_Update_OpsReport()
        {
            AddParents();
            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_DeleteFromStore_Can_Delete_OpsReport()
        {
            AddParents();
            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);
        ...
        [TestMethod]
        public void OpsReport141WitsmlStore_GetFromStore_Can_Transform_OpsReport()
        {
            AddParents();
            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_AddToStore_Creates_ChangeLog()
        {
            AddParents();

            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);

            var result = DevKit.GetAndAssert<OpsReportList, OpsReport>(OpsReport);
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_UpdateInStore_Updates_ChangeLog()
        {
            AddParents();

            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);

            // Update the OpsReport141
            OpsReport.Name = "Change";
            DevKit.UpdateAndAssert(OpsReport);
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_DeleteFromStore_Updates_ChangeLog()
        {
            AddParents();

            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);

            // Delete the OpsReport141
            DevKit.DeleteAndAssert(OpsReport);

            var expectedHistoryCount = 2;
            var expectedChangeType = ChangeInfoType.delete;
            DevKit.AssertChangeLog(OpsReport, expectedHistoryCount, expectedChangeType);
        }

        [TestMethod]
        public void OpsReport141DataAdapter_ChangeLog_Tracks_ChangeHistory_For_Add_Update_Delete()
        {
            AddParents();

            // Add the OpsReport141
            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);
            ...
            result = DevKit.GetAndAssert<OpsReportList, OpsReport>(OpsReport);
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_GetFromStore_Filter_ExtensionNameValue()
        {
            AddParents();
            ...
            var queryXml = string.Format(BasicXMLTemplate, OpsReport.UidWell, OpsReport.UidWellbore, OpsReport.Uid, extValueQuery);
            var result = DevKit.Query<OpsReportList, OpsReport>(ObjectTypes.OpsReport, queryXml, null, OptionsIn.ReturnElements.Requested);
            Assert.IsNotNull(result);
            Assert.AreEqual(1, result.Count);

            var resultOpsReport = result[0];
            Assert.IsNotNull(resultOpsReport);

            var commonData = resultOpsReport.CommonData;
            ...
            queryXml = string.Format(BasicXMLTemplate, OpsReport.UidWell, OpsReport.UidWellbore, OpsReport.Uid, extValueQuery);
            result = DevKit.Query<OpsReportList, OpsReport>(ObjectTypes.OpsReport, queryXml, null, OptionsIn.ReturnElements.Requested);
            Assert.IsNotNull(result);
            Assert.AreEqual(1, result.Count);

            resultOpsReport = result[0];
            Assert.IsNotNull(resultOpsReport);

            commonData = resultOpsReport.CommonData;
            Assert.IsNotNull(commonData);
            Assert.AreEqual(1, commonData.ExtensionNameValue.Count);
        ...
        [TestMethod]
        public void OpsReport141DataAdapter_ChangeLog_Syncs_OpsReport_Name_Changes()
        {
            AddParents();
            ...
            // Assert that all OpsReport names match corresponding changeLog names
            DevKit.AssertChangeLogNames(OpsReport);

            // Update the OpsReport141 names
            OpsReport.Name = "Change";
            OpsReport.NameWell = "Well Name Change";

            OpsReport.NameWellbore = "Wellbore Name Change";
