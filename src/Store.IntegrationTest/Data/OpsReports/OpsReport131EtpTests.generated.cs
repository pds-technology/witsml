...
{
    [TestClass]
    public partial class OpsReport131EtpTests : OpsReport131TestBase
    {
        public OpsReport131EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void OpsReport131_Ensure_Creates_OpsReport_With_Default_Values()
        {
            DevKit.EnsureAndAssert<OpsReportList, OpsReport>(OpsReport);
        }

        [TestMethod]
        public async Task OpsReport131_GetResources_Can_Get_All_OpsReport_Resources()
        {
            AddParents();
            DevKit.AddAndAssert<OpsReportList, OpsReport>(OpsReport);
            await RequestSessionAndAssert();

            var uri = OpsReport.GetUri();
        ...
        [TestMethod]
        public async Task OpsReport131_PutObject_Can_Add_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject<OpsReportList, OpsReport>(uri, OpsReport);
            ...
            var result = Parse<OpsReportList, OpsReport>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task OpsReport131_PutObject_Can_Update_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var updateDataObject = CreateDataObject<OpsReportList, OpsReport>(uri, result);
            ...
            result = Parse<OpsReportList, OpsReport>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task OpsReport131_DeleteObject_Can_Delete_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
