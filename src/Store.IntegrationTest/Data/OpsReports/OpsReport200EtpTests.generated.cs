...
{
    [TestClass]
    public partial class OpsReport200EtpTests : OpsReport200TestBase
    {
        public OpsReport200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void OpsReport200_Ensure_Creates_OpsReport_With_Default_Values()
        {
            DevKit.EnsureAndAssert(OpsReport);
        }

        [TestMethod]
        public async Task OpsReport200_GetResources_Can_Get_All_OpsReport_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(OpsReport.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task OpsReport200_PutObject_Can_Add_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, OpsReport);
            ...
            var result = Parse<OpsReport>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task OpsReport200_PutObject_Can_Update_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            OpsReport.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<OpsReport>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task OpsReport200_DeleteObject_Can_Delete_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
