...
{
    [TestClass]
    public partial class OpsReport141EtpTests : OpsReport141TestBase
    {
        public OpsReport141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void OpsReport141_Ensure_Creates_OpsReport_With_Default_Values()
        {
            DevKit.EnsureAndAssert<OpsReportList, OpsReport>(OpsReport);
        }

        [TestMethod]
        public async Task OpsReport141_GetResources_Can_Get_All_OpsReport_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task OpsReport141_PutObject_Can_Add_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task OpsReport141_PutObject_Can_Update_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task OpsReport141_DeleteObject_Can_Delete_OpsReport()
        {
            AddParents();
            await RequestSessionAndAssert();
