...
namespace PDS.WITSMLstudio.Store.Data.Wellbores
{
    ...
    public partial class Wellbore200EtpTests : Wellbore200TestBase
    {
        ...
        [TestMethod]
        public async Task Wellbore200_GetResources_Can_Get_All_Wellbore_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(Wellbore.Well.GetUri());
        ...
        public async Task Wellbore200_PutObject_Can_Update_Wellbore()
        {
            ...
            Wellbore.ExtensionNameValue = new List<ExtensionNameValue>() {env};
        ...
        [TestMethod]
        public async Task Wellbore200_DeleteObject_Can_Delete_Wellbore()
        {
            AddParents();
            await RequestSessionAndAssert();
