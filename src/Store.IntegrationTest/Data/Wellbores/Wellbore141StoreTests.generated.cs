...
namespace PDS.WITSMLstudio.Store.Data.Wellbores
{
    ...
    public partial class Wellbore141StoreTests : Wellbore141TestBase
    {
        ...
        [TestMethod]
        public void Wellbore141DataAdapter_GetFromStore_Filter_ExtensionNameValue()
        {
            AddParents();
            ...
            var queryXml = string.Format(BasicXMLTemplate, Wellbore.UidWell, Wellbore.Uid, extValueQuery);
            var result = DevKit.Query<WellboreList, Wellbore>(ObjectTypes.Wellbore, queryXml, null, OptionsIn.ReturnElements.Requested);
            Assert.IsNotNull(result);
            Assert.AreEqual(1, result.Count);

            var resultWellbore = result[0];
            Assert.IsNotNull(resultWellbore);

            var commonData = resultWellbore.CommonData;
            ...
            queryXml = string.Format(BasicXMLTemplate, Wellbore.UidWell, Wellbore.Uid, extValueQuery);
            result = DevKit.Query<WellboreList, Wellbore>(ObjectTypes.Wellbore, queryXml, null, OptionsIn.ReturnElements.Requested);
            Assert.IsNotNull(result);
            Assert.AreEqual(1, result.Count);

            resultWellbore = result[0];
            Assert.IsNotNull(resultWellbore);

            commonData = resultWellbore.CommonData;
            Assert.IsNotNull(commonData);
            Assert.AreEqual(1, commonData.ExtensionNameValue.Count);
