...
{
    public abstract partial class RigUtilization200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected RigUtilization200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
