...
{
    [TestClass]
    public partial class ConvCore131EtpTests : ConvCore131TestBase
    {
        public ConvCore131EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void ConvCore131_Ensure_Creates_ConvCore_With_Default_Values()
        {
            DevKit.EnsureAndAssert<ConvCoreList, ConvCore>(ConvCore);
        }

        [TestMethod]
        public async Task ConvCore131_GetResources_Can_Get_All_ConvCore_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task ConvCore131_PutObject_Can_Add_ConvCore()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task ConvCore131_PutObject_Can_Update_ConvCore()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task ConvCore131_DeleteObject_Can_Delete_ConvCore()
        {
            AddParents();
            await RequestSessionAndAssert();
