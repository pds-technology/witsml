...
{
    [TestClass]
    public partial class ConvCore131StoreTests : ConvCore131TestBase
    {
        public ConvCore131StoreTests()
            : base(false)
        {
        }

        [TestMethod]
        public void ConvCore131DataAdapter_GetFromStore_Can_Get_ConvCore()
        {
            AddParents();
        ...
        [TestMethod]
        public void ConvCore131DataAdapter_AddToStore_Can_Add_ConvCore()
        {
            AddParents();
            DevKit.AddAndAssert<ConvCoreList, ConvCore>(ConvCore);
        }
        ...
        [TestMethod]
        public void ConvCore131DataAdapter_UpdateInStore_Can_Update_ConvCore()
        {
            AddParents();
            DevKit.AddAndAssert<ConvCoreList, ConvCore>(ConvCore);
        ...
        [TestMethod]
        public void ConvCore131DataAdapter_DeleteFromStore_Can_Delete_ConvCore()
        {
            AddParents();
            DevKit.AddAndAssert<ConvCoreList, ConvCore>(ConvCore);
        ...
        [TestMethod]
        public void ConvCore131WitsmlStore_GetFromStore_Can_Transform_ConvCore()
        {
            AddParents();
            DevKit.AddAndAssert<ConvCoreList, ConvCore>(ConvCore);
