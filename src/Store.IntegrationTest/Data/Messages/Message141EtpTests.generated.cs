...
namespace PDS.WITSMLstudio.Store.Data.Messages
{
    ...
    public partial class Message141EtpTests : Message141TestBase
    {
        ...
        [TestMethod]
        public async Task Message141_GetResources_Can_Get_All_Message_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Message141_PutObject_Can_Update_Message()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Message141_DeleteObject_Can_Delete_Message()
        {
            AddParents();
            await RequestSessionAndAssert();
