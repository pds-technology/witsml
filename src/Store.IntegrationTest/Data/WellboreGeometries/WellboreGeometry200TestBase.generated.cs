...
{
    public abstract partial class WellboreGeometry200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected WellboreGeometry200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
