...
namespace PDS.WITSMLstudio.Store.Data.WellCMLedgers
{
    ...
    public partial class WellCMLedger200StoreTests : WellCMLedger200TestBase
    {
        ...
        [TestMethod]
        public void WellCMLedger200DataAdapter_GetFromStore_Can_Get_WellCMLedger()
        {
            AddParents();
            DevKit.AddAndAssert(WellCMLedger);
            DevKit.GetAndAssert(WellCMLedger);
       }
        ...
        [TestMethod]
        public void WellCMLedger200DataAdapter_UpdateInStore_Can_Update_WellCMLedger()
        {
            AddParents();
            DevKit.AddAndAssert(WellCMLedger);
        ...
        [TestMethod]
        public void WellCMLedger200DataAdapter_DeleteFromStore_Can_Delete_WellCMLedger()
        {
            AddParents();
            DevKit.AddAndAssert(WellCMLedger);
            DevKit.DeleteAndAssert(WellCMLedger);
            DevKit.GetAndAssert(WellCMLedger, isNotNull: false);
        }
    }
}