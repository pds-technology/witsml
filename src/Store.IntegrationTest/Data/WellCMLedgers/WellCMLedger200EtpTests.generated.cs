...
{
    [TestClass]
    public partial class WellCMLedger200EtpTests : WellCMLedger200TestBase
    {
        public WellCMLedger200EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void WellCMLedger200_Ensure_Creates_WellCMLedger_With_Default_Values()
        {
            DevKit.EnsureAndAssert(WellCMLedger);
        }

        [TestMethod]
        public async Task WellCMLedger200_GetResources_Can_Get_All_WellCMLedger_Resources()
        {
            AddParents();
            ...
            await GetResourcesAndAssert(WellCMLedger.Wellbore.GetUri());
        ...
        [TestMethod]
        public async Task WellCMLedger200_PutObject_Can_Add_WellCMLedger()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject(uri, WellCMLedger);
            ...
            var result = Parse<WellCMLedger>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task WellCMLedger200_PutObject_Can_Update_WellCMLedger()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            WellCMLedger.ExtensionNameValue = new List<ExtensionNameValue>() {env};
            ...
            result = Parse<WellCMLedger>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task WellCMLedger200_DeleteObject_Can_Delete_WellCMLedger()
        {
            AddParents();
            await RequestSessionAndAssert();
