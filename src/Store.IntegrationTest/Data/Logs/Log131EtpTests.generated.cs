...
namespace PDS.WITSMLstudio.Store.Data.Logs
{
    ...
    public partial class Log131EtpTests : Log131TestBase
    {
        ...
        [TestMethod]
        public async Task Log131_GetResources_Can_Get_All_Log_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Log131_PutObject_Can_Update_Log()
        {
            AddParents();
            await RequestSessionAndAssert();
        ...
        [TestMethod]
        public async Task Log131_DeleteObject_Can_Delete_Log()
        {
            AddParents();
            await RequestSessionAndAssert();
