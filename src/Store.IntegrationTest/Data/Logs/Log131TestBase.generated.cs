...
{
    public abstract partial class Log131TestBase : IntegrationTestFixtureBase<DevKit131Aspect>
    {
        ...
        public const string QueryMissingVersion = "<logs xmlns=\"http://www.witsml.org/schemas/131\"></logs>";
        ...
        public const string BasicXMLTemplate = "<logs xmlns=\"http://www.witsml.org/schemas/131\" version=\"1.3.1.1\"><log uidWell=\"{0}\" uidWellbore=\"{1}\" uid=\"{2}\">{3}</log></logs>";

        protected Log131TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
