...
{
    public abstract partial class DrillReport200TestBase : IntegrationTestFixtureBase<DevKit200Aspect>
    {

        protected DrillReport200TestBase(bool isEtpTest = false)
            : base(isEtpTest)
        {
        }
        ...
        protected override void PrepareData()
        {
            ...
            {
                Uuid = DevKit.Uid(),
                Citation = DevKit.Citation("DrillReport"),
                Wellbore = DevKit.DataObjectReference(Wellbore),
                SchemaVersion = EtpUris.GetUriFamily(typeof(DrillReport)).Version,
            };
