...
{
    [TestClass]
    public partial class DrillReport141EtpTests : DrillReport141TestBase
    {
        public DrillReport141EtpTests()
            : base(true)
        {
        }

        [TestMethod]
        public void DrillReport141_Ensure_Creates_DrillReport_With_Default_Values()
        {
            DevKit.EnsureAndAssert<DrillReportList, DrillReport>(DrillReport);
        }

        [TestMethod]
        public async Task DrillReport141_GetResources_Can_Get_All_DrillReport_Resources()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task DrillReport141_PutObject_Can_Add_DrillReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var dataObject = CreateDataObject<DrillReportList, DrillReport>(uri, DrillReport);
            ...
            var result = Parse<DrillReportList, DrillReport>(xml);
            Assert.IsNotNull(result);
        }

        [TestMethod]
        public async Task DrillReport141_PutObject_Can_Update_DrillReport()
        {
            AddParents();
            await RequestSessionAndAssert();
            ...
            var updateDataObject = CreateDataObject<DrillReportList, DrillReport>(uri, result);
            ...
            result = Parse<DrillReportList, DrillReport>(updateXml);
            Assert.IsNotNull(result);
        ...
        [TestMethod]
        public async Task DrillReport141_DeleteObject_Can_Delete_DrillReport()
        {
            AddParents();
            await RequestSessionAndAssert();
