...
namespace PDS.Witsml.Server
{
    ...
    public class WitsmlStore141Tests
    {
        ...
        public void Adding_wellbore_database_configuration_error()
        {
            ...
            var dbProvider = new TestDatabaseProvider(new Data.Mapper(), string.Empty);
        ...
        public void Test_error_code_411_optionsIn_invalid_format()
        {
            ...
            Assert.IsNotNull(response);
            Assert.AreEqual((short)ErrorCodes.OptionsInInvalidFormat, response.Result);
        }
        ...
        public void Test_error_code_440_optionsIn_keyword_not_recognized()
        {
            ...
            Assert.IsNotNull(response);
            Assert.AreEqual((short)ErrorCodes.OptionsInKeywordNotRecognized, response.Result);
        }
        ...
        public void Test_error_code_441_optionsIn_value_not_recognized()
        {
            ...
            Assert.IsNotNull(response);
            Assert.AreEqual((short)ErrorCodes.OptionsInValueNotRecognized, response.Result);
        }
        ...
        public void Test_error_code_468_missing_version_attribute()
        {
            ...
            Assert.IsNotNull(response);
            Assert.AreEqual((short)ErrorCodes.MissingVersionAttribute, response.Result);
        }
