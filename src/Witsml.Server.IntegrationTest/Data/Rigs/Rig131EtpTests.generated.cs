...
{
    [TestClass]
    public partial class Rig131EtpTests : Rig131TestBase
    {
        ...
        [TestMethod]
        public async Task Rig131_PutObject_Can_Add_Rig()
        {
            AddParents();
        ...
        [TestMethod]
        public async Task Rig131_PutObject_Can_Update_Rig()
        {
            AddParents();
            ...
            var updateDataObject = CreateDataObject<RigList, Rig>(uri, Rig);
