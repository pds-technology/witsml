...
namespace PDS.Witsml.Server.Linq
{
    ...
    public class Witsml141ContextTests
    {
        ...
        public Witsml141Context Context { get; set; }
        ...
        public void TestSetUp()
        {
            ...
            Context = new Witsml141Context(url);
        ...
        [TestMethod]
        public void Witsml141Context_Connection_Can_Get_Version()
        {
        ...
        [TestMethod]
        public void Witsml141Context_Connection_Can_Get_Capabilities()
        {
            var response = Context.Connection.GetCap<CapServers>(OptionsIn.DataVersion.Version141);
            Assert.IsNotNull(response);
        }
       
        [TestMethod]
        public void Witsml141Context_Well_Can_Query_For_All_Wells()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_GetAllWells_Can_Query_For_All_Wells()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_Wellbore_Can_Query_For_All_Wellbores()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_GetAllWellbores_Can_Query_For_All_Wells()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_Log_Can_Query_For_All_Logs()
        {
            AddParents();
            AddLog();
        ...
        [TestMethod]
        public void Witsml141Context_Rig_Can_Query_For_All_Rigs()
        {
            //AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_Trajectory_Can_Query_For_All_Trajectories()
        {
            //AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_Logs_Can_Query_For_Log_Header()
        {
            AddParents();
            AddLog();
            ...
            var log = logs.Find(x => x.NameWell == Well.Name && x.NameWellbore == Wellbore.Name && x.Name == Log.Name);
        ...
        [TestMethod]
        public void Witsml141Context_Wells_Can_Query_For_Well_By_Uid()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_Wellbores_Can_Query_For_Wellbores_By_Uid()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_Wellbores_Can_Query_For_Logs_By_Uid()
        {
            AddParents();
            AddLog();
        ...
        [TestMethod]
        public void Witsml141Context_Wells_Can_Query_For_Well_By_Name()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_Wellbores_Can_Query_For_Wellbores_By_Well_Name()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_Wellbores_Can_Query_For_Logs_By_Name()
        {
            AddParents();
            AddLog();
        ...
        [TestMethod]
        public void Witsml141Context_GetWellboreObjects_Can_Query_For_Wellbore_Objects()
        {
            AddParents();
            AddLog();
        ...
        [TestMethod]
        public void Witsml141Context_GetObjectDetails_Can_Query_For_Object_Details()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_GetObjectIdOnly_Can_Query_For_Object_Ids()
        {
            AddParents();
        ...
        [TestMethod]
        public void Witsml141Context_GetGrowingObjectHeaderOnly_Can_Query_For_Growing_Object_Header_Only()
        {
            AddParents();
            AddLog();
        ...
        [TestMethod]
        public void Witsml141Context_Wells_Can_Query_For_Well_Hiererchy()
        {
            AddParents();
            AddLog();
