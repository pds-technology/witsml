...
namespace PDS.WITSMLstudio.Store.Data.FluidsReports
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.WitsmlDataProvider{FluidsReportList, FluidsReport}" />
    [Export(typeof(IEtpDataProvider))]
    [Export(typeof(IEtpDataProvider<FluidsReport>))]
    [Export131(ObjectTypes.FluidsReport, typeof(IEtpDataProvider))]
    [Export131(ObjectTypes.FluidsReport, typeof(IWitsmlDataProvider))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class FluidsReport131DataProvider : WitsmlDataProvider<FluidsReportList, FluidsReport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FluidsReport131DataProvider"/> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="dataAdapter">The data adapter.</param>
        [ImportingConstructor]
        public FluidsReport131DataProvider(IContainer container, IWitsmlDataAdapter<FluidsReport> dataAdapter) : base(container, dataAdapter)
        {
        }
        ...
        protected override void SetDefaultValues(FluidsReport dataObject)
        {
        ...
        protected override void SetDefaultValues(FluidsReport dataObject, EtpUri uri)
        {
        ...
        /// <summary>
        /// Creates a new <see cref="FluidsReportList" /> instance containing the specified data objects.
        /// </summary>
        /// <param name="dataObjects">The data objects.</param>
        /// <returns>A new <see cref="FluidsReportList" /> instance.</returns>
        protected override FluidsReportList CreateCollection(List<FluidsReport> dataObjects)
        {
            return new FluidsReportList { FluidsReport = dataObjects };
        }
        ...
        /// </summary>
        /// <param name="dataObject">The data object.</param>
        partial void SetAdditionalDefaultValues(FluidsReport dataObject);
