...
namespace PDS.WITSMLstudio.Store.Data.DownholeComponents
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.WitsmlDataProvider{DownholeComponentList, DownholeComponent}" />
    [Export(typeof(IEtpDataProvider))]
    [Export(typeof(IEtpDataProvider<DownholeComponent>))]
    [Export141(ObjectTypes.DownholeComponent, typeof(IEtpDataProvider))]
    [Export141(ObjectTypes.DownholeComponent, typeof(IWitsmlDataProvider))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class DownholeComponent141DataProvider : WitsmlDataProvider<DownholeComponentList, DownholeComponent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DownholeComponent141DataProvider"/> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="dataAdapter">The data adapter.</param>
        [ImportingConstructor]
        public DownholeComponent141DataProvider(IContainer container, IWitsmlDataAdapter<DownholeComponent> dataAdapter) : base(container, dataAdapter)
        {
        }
        ...
        /// <summary>
        /// Creates a new <see cref="DownholeComponentList" /> instance containing the specified data objects.
        /// </summary>
        /// <param name="dataObjects">The data objects.</param>
        /// <returns>A new <see cref="DownholeComponentList" /> instance.</returns>
        protected override DownholeComponentList CreateCollection(List<DownholeComponent> dataObjects)
        {
            return new DownholeComponentList { DownholeComponent = dataObjects };
        }
