...
namespace PDS.WITSMLstudio.Store.Data.CementJobs
{
    ...
    public partial class CementJob200Validator : DataObjectValidator<CementJob>
    {
        private readonly IWitsmlDataAdapter<CementJob> _cementJobDataAdapter;

        /// <summary>
        /// Initializes a new instance of the <see cref="CementJob200Validator" /> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="cementJobDataAdapter">The cementJob data adapter.</param>
        [ImportingConstructor]
        public CementJob200Validator(
            IContainer container,
            IWitsmlDataAdapter<CementJob> cementJobDataAdapter)
            : base(container)
        {
            _cementJobDataAdapter = cementJobDataAdapter;
        }
    }
}