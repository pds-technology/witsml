...
namespace PDS.WITSMLstudio.Store.Data.Channels
{
    ...
    public partial class Channel200DataProvider : EtpDataProvider<Channel>
    {
        ...
        protected override void SetDefaultValues(Channel dataObject)
        {
        ...
        protected override void UpdateDefaultValues(Channel dataObject, WitsmlQueryParser parser)
        {
        ...
        /// </summary>
        /// <param name="dataObject">The data object.</param>
        partial void SetAdditionalDefaultValues(Channel dataObject);
