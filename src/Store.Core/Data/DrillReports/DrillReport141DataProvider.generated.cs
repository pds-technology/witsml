...
namespace PDS.WITSMLstudio.Store.Data.DrillReports
{
    ...
    [Export141(ObjectTypes.DrillReport, typeof(IEtpDataProvider))]
    ...
    public partial class DrillReport141DataProvider : WitsmlDataProvider<DrillReportList, DrillReport>
    {
        ...
        public DrillReport141DataProvider(IContainer container, IWitsmlDataAdapter<DrillReport> dataAdapter) : base(container, dataAdapter)
        {
        }
        ...
        protected override void SetDefaultValues(DrillReport dataObject)
        {
        ...
        protected override void SetDefaultValues(DrillReport dataObject, EtpUri uri)
        {
        ...
        protected override void UpdateDefaultValues(DrillReport dataObject, WitsmlQueryParser parser)
        {
            UpdateAdditionalDefaultValues(dataObject, parser);
        }

        /// <summary>
        /// Creates a new <see cref="DrillReportList" /> instance containing the specified data objects.
        /// </summary>
        /// <param name="dataObjects">The data objects.</param>
        /// <returns>A new <see cref="DrillReportList" /> instance.</returns>
        protected override DrillReportList CreateCollection(List<DrillReport> dataObjects)
        {
            return new DrillReportList { DrillReport = dataObjects };
        }
        ...
        /// </summary>
        /// <param name="dataObject">The data object.</param>
        partial void SetAdditionalDefaultValues(DrillReport dataObject);
        ...
        /// <param name="dataObject">The data object.</param>
        /// <param name="parser">The input template.</param>
        partial void UpdateAdditionalDefaultValues(DrillReport dataObject, WitsmlQueryParser parser);
    }
}