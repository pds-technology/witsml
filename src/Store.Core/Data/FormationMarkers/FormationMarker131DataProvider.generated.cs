...
namespace PDS.WITSMLstudio.Store.Data.FormationMarkers
{
    ...
    [Export131(ObjectTypes.FormationMarker, typeof(IEtpDataProvider))]
    ...
    public partial class FormationMarker131DataProvider : WitsmlDataProvider<FormationMarkerList, FormationMarker>
    {
        ...
        public FormationMarker131DataProvider(IContainer container, IWitsmlDataAdapter<FormationMarker> dataAdapter) : base(container, dataAdapter)
        {
        }
