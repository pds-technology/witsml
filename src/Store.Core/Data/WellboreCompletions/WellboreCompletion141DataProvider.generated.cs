...
namespace PDS.WITSMLstudio.Store.Data.WellboreCompletions
{
    ...
    /// </summary>
    /// <seealso cref="PDS.WITSMLstudio.Store.Data.WitsmlDataProvider{WellboreCompletionList, WellboreCompletion}" />
    [Export(typeof(IEtpDataProvider))]
    [Export(typeof(IEtpDataProvider<WellboreCompletion>))]
    [Export141(ObjectTypes.WellboreCompletion, typeof(IEtpDataProvider))]
    [Export141(ObjectTypes.WellboreCompletion, typeof(IWitsmlDataProvider))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class WellboreCompletion141DataProvider : WitsmlDataProvider<WellboreCompletionList, WellboreCompletion>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WellboreCompletion141DataProvider"/> class.
        /// </summary>
        /// <param name="container">The composition container.</param>
        /// <param name="dataAdapter">The data adapter.</param>
        [ImportingConstructor]
        public WellboreCompletion141DataProvider(IContainer container, IWitsmlDataAdapter<WellboreCompletion> dataAdapter) : base(container, dataAdapter)
        {
        }
        ...
        /// <summary>
        /// Creates a new <see cref="WellboreCompletionList" /> instance containing the specified data objects.
        /// </summary>
        /// <param name="dataObjects">The data objects.</param>
        /// <returns>A new <see cref="WellboreCompletionList" /> instance.</returns>
        protected override WellboreCompletionList CreateCollection(List<WellboreCompletion> dataObjects)
        {
            return new WellboreCompletionList { WellboreCompletion = dataObjects };
        }
